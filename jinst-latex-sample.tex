...
A total detection efficiency of 94\% was obtained with a single plane, while the fraction of events with multiplicity $M>1$ represented 24\%, mainly due to cross talk between adjacent channels of the multi-anode PMT. For these measurements, the intensity of the 95~MeV/u carbon ions beam was between 20 to 30~pA.
